...
from ..params.cipher_parameters import CipherParameters
...
class PaddedBufferedBlockCipher:
    ...
    def __init__(self, cipher: BlockCipher, padding: BlockCipherPadding):
        """
        构造函数
    ...
    def get_underlying_cipher(self) -> BlockCipher:
        """获取底层密码"""
        return self.cipher
